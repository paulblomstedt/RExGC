...
% Modified by Paul Blomstedt 3.2.2015 (added line 153 and function output on line 37 to get NID)

% function [AMI_]=AMI(true_mem,mem) % original function call
function [AMI_,NID]=AMI(true_mem,mem)
if nargin==1
...
NID=1-MI/max(Ha,Hb); % PB: added 3.2.2015
